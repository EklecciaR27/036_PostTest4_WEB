            ...
            <form action="formaction.php" method="post">
                <div class="input-row">
                    <div class="input-group">
                        <label>Gender</label>
                        <input type="text"  name="name" placeholder="Williams S">
                    </div>
                    <div class="input-group">
                        <label>Email</label>
                ...
                <div class="input-row">
                    <div class="input-group">
                        ...
                        <input type="number"  name="phone" placeholder="+123 455 2**">
                    </div>
                    <div class="input-group">
                ...
                <label>Message</label>
                <textarea rows="5" placeholder="Drop ur Message"></textarea>
